...
useage() {
	echo "Useage: ./bootstrap-workstation.sh <install directory>"
}
...
echo "i2p-os-workstation" > /etc/hostname
...
cp "resources/workstation/Wired connection 1.nmconnection" "$target/etc/NetworkManager/system-connections/"
